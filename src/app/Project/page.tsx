          ...
          <div>
           <div className=" text-center text-3xl font-bold mt-16 lg:text-center lg:text-4xl lg:font-bold lg:mt-16">
              ...
              <div className="flex  flex-col  lg:flex-row lg:mt-24">
                <div className="text-center mt-3 mx-5 md:mx-48 md:text-center md:mt-3  lg:mt-16 lg:mx-5 lg:text-center">
                ...
                <div className="text-center mt-3 mx-5 md:mx-48 md:text-center md:mt-3  lg:ml-4 lg:mt-16 lg:text-center">
